...
class _PaymentsState extends State<Payments> {
  ...
  List<Map<String, dynamic>> products = [
    {
      'images': 'asset/blue shirt man.jpeg',
      'title': 'Order #1688068',
      'price': '₹799',
      'date': 'Jul 12, 02:08 PM'
    },
    {
      'images': 'asset/white-black-printed.webp',
      'title': 'Order #14577741',
      'price': '₹799',
      'date': 'Apr 26, 07:47 AM'
    },
    {
      'images': 'asset/blue t.jpeg',
      'title': 'Order #1685889',
      'price': '₹399',
      'date': 'Apr 11, 10:54 AM'
    },
    {
      'images': 'asset/black folded t.png',
      'title': 'Order #4674389',
      'price': '₹699',
      'date': 'Apr 2, 11:29 AM'
    },
    {
      'images': 'asset/T shirt hanger.webp',
      'title': 'Order #1688788',
      'price': '₹449',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      IconButton(onPressed: (){Navigator.of(context).push(MaterialPageRoute(builder: (ctx){
return MyApp();
      }));},
          ...
          Row(
            ...
            children: [
              ElevatedButton(
                style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all<Color>(const Color.fromARGB(255, 231, 224, 224)),
              ...
              ElevatedButton(
                ...
                onPressed: () {},
                child: Text(
                  'Payouts (151)',style: TextStyle(color: Colors.white),
              ...
              ElevatedButton(
                style: ButtonStyle(
                  backgroundColor:
                      MaterialStateProperty.all<Color>(const Color.fromARGB(255, 233, 224, 224)),
                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                    RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(26),
                    ),
